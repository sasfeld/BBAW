 ...
 * 
 */
public class ModsMetadataParser extends MetadataParser {
   ...
   */
  public ModsMetadataParser(final String uri, final HashMap<String, String> namespaces) throws ApplicationException {
