...
/**
 * This class offers the {@link MetadataParser} instances.
...
public class MetadataParserFactory {
   ...
   * @throws ApplicationException if the resource to be parsed is not validated by Saxon.
   */
   ...
   * @param uri the xml resource to be parsed.
